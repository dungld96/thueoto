            ...
            <div class="result-header">
                ...
                <div id="mb-address-daterange">
                    <div class="mb-content-address-daterange">
                        <p id="mb-plade">Hà Nội, Việt Nam</p>
                        <p id="mb-date-range">
                            <span id="mb-start-date">10/07/2019 </span><span id="mb-start-time">00:00</span> -
                            <span id="mb-end-date">10/07/2019 </span><span id="mb-end-time">00:00</span>
                        </p>
                    </div>
